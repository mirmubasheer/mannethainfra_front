                        ...
                        <div className="header-right flx-align">
                            ...
                            
                            {
                                props.showOffCanvasBtn && (
                                    <button 
                                    className="btn btn-outline-light d-lg-block d-none" 
                                    onClick={() => { handleOffCanvas(); handleScrollHideLg(); }}  // Open OffCanvas on button click
                                >
                                    Visit Us 
                                    <span className={props.spanClass}>
                                        <i className={props.iconClass}></i>  {/* Adding the icon here */}
                                    </span>
                                </button>
