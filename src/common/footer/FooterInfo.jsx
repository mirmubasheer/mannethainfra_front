                        ...
                        return (
                            ...
                            <div className="contact-info d-flex gap-2">
                                ...
                                {/* <span className="contact-info__text text-white">{footerInfo.text2}</span> */}
                                    ...
                                    <span className="contact-info__address text-white">{footerInfo.address1}</span>
