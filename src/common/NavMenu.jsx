...
const NavMenu = (props) => {
    ...
    const handleMenuClick = () => {
        if (props.closeMenu) {
            props.closeMenu(); // Call closeMenu prop when a menu item is clicked
        }
    };
                        ...
                        return (
                            ...
                            >
                                <NavLink 
                                    ...
                                    onClick={handleMenuClick} // Close menu on main item click
                                >
                                    {navMenu.text}
                                </NavLink>
                                {
                                                ...
                                                navMenu.submenus.map((submenu, subIndex) => (
                                                    ...
                                                    >
                                                        <Link 
                                                            ...
                                                            onClick={handleMenuClick} // Close menu on submenu click
                                                        >
                                                            {submenu.text}
                                                        </Link>
                                                    </li>
