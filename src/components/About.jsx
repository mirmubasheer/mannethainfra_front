                                ...
                                <div className="client-statistics flx-align">
                                    ...
                                    <div className="client-statistics__content">
                                        <h5 className="client-statistics__number statisticsCounter">
                                            <CountUp end={parseInt(aboutStatistics.number)}suffix="+"/>
                                        </h5>
                        ...
                        <div className="col-lg-6">
                            <div className="about-content">
                                ...
                                <SectionHeading 
                                    ...
                                    subtitle="About Mannetha Infra"
                                    subtitleClass="" 
                                    title="Leaders in Real Estate Excellence" 
                                    renderDesc={false}
                                    desc=""
                                    renderButton={false}
                                ...
                                <div className="about-box d-flex">
                                    ...
                                    <p className="about-box__desc font-13" style={{ textAlign: 'justify' }}>{aboutContent.desc}</p>
                                </div>
